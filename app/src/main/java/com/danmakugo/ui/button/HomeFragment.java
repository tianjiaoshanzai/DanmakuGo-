...
import com.danmakugo.adapter.FmPagerAdapter;
...
//        appCompatActivity.setSupportActionBar(toolbar);
    ...
    private void initTab() {
        ...
        String[] tabNames={"今日推荐","热帖","热门弹幕"};


        // 添加 tab item
        fragments.add(new com.danmakugo.ui.button.RecommendHomeFragment());
        tabLayout.addTab(tabLayout.newTab());

        fragments.add(new com.danmakugo.ui.button.HotPostHomeFragment());
        tabLayout.addTab(tabLayout.newTab());

        fragments.add(new com.danmakugo.ui.button.HotDanmakuHomeFragment());
        tabLayout.addTab(tabLayout.newTab());
